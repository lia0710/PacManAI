...
public class BlinkySpreadState : GhostBaseState
{
    ...
    override public void OnStateEnter(Animator animator, AnimatorStateInfo stateInfo, int layerIndex)
    {
        ...
        loc1 = new Vector2(8, 9);
        loc2 = new Vector2(8, 6);
        loc3 = new Vector2(5, 6);
        loc4 = new Vector2(5, 9);
        currentTarget = new Vector2(5, 6);
